...
replace github.com/sandertv/gophertunnel v1.42.0 => ../gophertunnel

replace github.com/sandertv/go-raknet v1.14.2 => ../go-raknet

replace github.com/df-mc/dragonfly v0.9.18-0.20240818101738-29a214b79bd5 => ../dragonfly
