...
type Handler interface {
	...
	HandlePunishment(ctx *event.Context, check check.Check, params map[string]interface{})
...
// HandlePunishment ...
func (NopHandler) HandlePunishment(*event.Context, check.Check, map[string]interface{}) {}
