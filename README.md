...
The [standalone proxy module](./proxy) may also be used without Oomph when only connection forwarding, instant transfers, backend fallback, and transfer-state cleanup are needed.
